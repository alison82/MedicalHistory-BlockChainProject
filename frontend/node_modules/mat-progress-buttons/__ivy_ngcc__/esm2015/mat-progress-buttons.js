...
function MatSpinnerButtonComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("is-mat-icon", !ctx_r472.options.buttonIcon.fontSet)("active", ctx_r472.options.active && !ctx_r472.options.disabled);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r472.options.buttonIcon.customClass)("fontSet", ctx_r472.options.buttonIcon.fontSet)("fontIcon", ctx_r472.options.buttonIcon.fontIcon)("color", ctx_r472.options.buttonIcon.color)("svgIcon", ctx_r472.options.buttonIcon.svgIcon)("inline", ctx_r472.options.buttonIcon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r472.options.buttonIcon.fontSet ? "" : ctx_r472.options.buttonIcon.fontIcon, " ");
} }
function MatSpinnerButtonComponent_span_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("active", ctx_r473.options.active && !ctx_r473.options.disabled);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r473.options.text, " ");
} }
function MatSpinnerButtonComponent_ng_container_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("fontSet", ctx_r474.options.icon.fontSet)("fontIcon", ctx_r474.options.icon.fontIcon)("color", ctx_r474.options.icon.color)("svgIcon", ctx_r474.options.icon.svgIcon)("inline", ctx_r474.options.icon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r474.options.icon.fontSet ? "" : ctx_r474.options.icon.fontIcon, " ");
} }
function MatSpinnerButtonComponent_mat_spinner_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵclassProp("active", ctx_r475.options.active && !ctx_r475.options.disabled);
    ɵngcc0.ɵɵproperty("diameter", ctx_r475.options.fab ? 58 : ctx_r475.options.spinnerSize)("color", ctx_r475.options.spinnerColor)("mode", ctx_r475.options.mode)("value", ctx_r475.options.value);
} }
function MatBarButtonComponent_ng_container_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵclassProp("is-mat-icon", !ctx_r476.options.buttonIcon.fontSet);
    ɵngcc0.ɵɵproperty("ngClass", ctx_r476.options.buttonIcon.customClass)("fontSet", ctx_r476.options.buttonIcon.fontSet)("fontIcon", ctx_r476.options.buttonIcon.fontIcon)("color", ctx_r476.options.buttonIcon.color)("svgIcon", ctx_r476.options.buttonIcon.svgIcon)("inline", ctx_r476.options.buttonIcon.inline);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r476.options.buttonIcon.fontSet ? "" : ctx_r476.options.buttonIcon.fontIcon, " ");
} }
function MatBarButtonComponent_mat_progress_bar_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("color", ctx_r477.options.barColor)("mode", ctx_r477.options.mode)("value", ctx_r477.options.value);
} }
